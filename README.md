...
You can explore this API and its features by visiting the [oopt-gnpy-api](https://github.com/Telecominfraproject/oopt-gnpy-api) repository. It provides a flexible interface to leverage the full power of GNPy in your projects.
