...
In this network, the *nodes* correspond to [amplifiers](yang-topology-amplifier), [ROADMs](yang-topology-roadm), [transceivers](yang-topology-transceiver) (and sometimes also [attenuators](yang-topology-attenuator)), while the *links* model [optical fiber](yang-topology-fiber) or [patchcords](yang-topology-patch)).
...
: Total length of the fiber, in $\text{m}$.
