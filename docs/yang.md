...
(yang-equipment-amplifier-cascaded)=
#### `cascaded`

A [cascaded](ext-nf-model-dual-stage-amplifier) amplifier combines two distinct amplifiers.
...
: A profile which gives the relation between the gain ripple and tilt.

`gain-ripple`

: Difference of the amplifier gain compared to the tilted, but linear gain as a function of a carrier frequency
