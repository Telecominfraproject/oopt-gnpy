    ...
    equipment = {
        ...
        'Span': {'default': _ji.Span(
            ...
            delta_power_range_db=[
                ...
                float(sim_data['autodesign']['power-mode']['long-span-power-boost'].value),
    ...
    for net in data['ietf-network:networks']['ietf-network:network']:
        ...
        for link in net['ietf-network-topology:link']:
            ...
            if 'tip-photonic-topology:fiber' in link:
                ...
                el = elements.Fused(
                    uid=link['link-id'].value,
                    params={
                        'loss': float(patch['attenuation'].value)
                    },
                    metadata={'location': location},
                )
                network.add_node(el)
        ...
        for link in net['ietf-network-topology:link']:
            ...
            if 'tip-photonic-topology:fiber' in link:
                ...
                network.add_edge(nodes[source], nodes[this_node], weight=0.01)
