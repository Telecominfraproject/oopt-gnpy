...
from gnpy.core.utils import (automatic_nch, automatic_fmax, merge_amplifier_restrictions, db2lin, dbm2watt,
                             merge_equalization)
    ...
    for el_config in json_data['elements']:
        ...
        if typ == 'Fused':
            ...
            if typ == 'Roadm':
                ...
                if not extra_params:
                    raise ConfigurationError('ROADM contains both per channel power and psd. please choose only one', el_config['uid'])
