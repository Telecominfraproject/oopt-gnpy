...
def _spectrum_from_json(json_data):
    ...
    >>> json_data = {'SI': \
        [{'f_min': 0, 'f_max': 9, 'slot_width': 1, 'baud_rate': 2.5, 'roll_off': 0.15, 'delta_pdb': 1},\
        {'f_min': 10, 'f_max': 20, 'slot_width': 2, 'baud_rate': 2.5, 'roll_off': 0.15}]}
    >>> spectrum = _spectrum_from_json(json_data['SI'])
    >>> for k, v in spectrum.items():
    ...     print(f'{k}: {v}')
    ... 
    1: {'slot_width': 1, 'baud_rate': 2.5, 'roll_off': 0.15, 'delta_pdb': 1, 'label': '0-0.0'}
    2: {'slot_width': 1, 'baud_rate': 2.5, 'roll_off': 0.15, 'delta_pdb': 1, 'label': '0-0.0'}
    3: {'slot_width': 1, 'baud_rate': 2.5, 'roll_off': 0.15, 'delta_pdb': 1, 'label': '0-0.0'}
    4: {'slot_width': 1, 'baud_rate': 2.5, 'roll_off': 0.15, 'delta_pdb': 1, 'label': '0-0.0'}
    5: {'slot_width': 1, 'baud_rate': 2.5, 'roll_off': 0.15, 'delta_pdb': 1, 'label': '0-0.0'}
    6: {'slot_width': 1, 'baud_rate': 2.5, 'roll_off': 0.15, 'delta_pdb': 1, 'label': '0-0.0'}
    7: {'slot_width': 1, 'baud_rate': 2.5, 'roll_off': 0.15, 'delta_pdb': 1, 'label': '0-0.0'}
    8: {'slot_width': 1, 'baud_rate': 2.5, 'roll_off': 0.15, 'delta_pdb': 1, 'label': '0-0.0'}
    9: {'slot_width': 1, 'baud_rate': 2.5, 'roll_off': 0.15, 'delta_pdb': 1, 'label': '0-0.0'}
    12: {'slot_width': 2, 'baud_rate': 2.5, 'roll_off': 0.15, 'label': '1-0.0', 'delta_pdb': 0}
    14: {'slot_width': 2, 'baud_rate': 2.5, 'roll_off': 0.15, 'label': '1-0.0', 'delta_pdb': 0}
    16: {'slot_width': 2, 'baud_rate': 2.5, 'roll_off': 0.15, 'label': '1-0.0', 'delta_pdb': 0}
    18: {'slot_width': 2, 'baud_rate': 2.5, 'roll_off': 0.15, 'label': '1-0.0', 'delta_pdb': 0}
    20: {'slot_width': 2, 'baud_rate': 2.5, 'roll_off': 0.15, 'label': '1-0.0', 'delta_pdb': 0}
    """
    spectrum = {}
    ...
    for index, part in enumerate(json_data):
        ...
        current_part_min_freq = part['f_min'] + part['slot_width'] / 2
