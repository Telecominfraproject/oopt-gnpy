...
class Roadm(_Node):
    ...
    def to_json(self):
        if self.ref_pch_out_dbm:
            ...
            perdegree, perdegreevalue = 'per_degree_pch_out_db', self.per_degree_pch_out_dbm
    ...
    def propagate(self, spectral_info, degree):
        ...
        if self.target_pch_out_dbm:
            ref_per_degree_pch = self.per_degree_pch_out_dbm.get(degree, self.target_pch_out_dbm)
...
class Edfa(_Node):
    ...
    def interpol_params(self, spectral_info):
        ...
        delta_channel_power = spectral_info.delta_pdb_per_channel
