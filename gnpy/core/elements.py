...
class Roadm(_Node):
    ...
    def propagate(self, pref, *carriers, degree):
        ...
        temp = self.per_degree_pch_out_db[degree] if degree in self.per_degree_pch_out_db.keys() \
            else self.params.target_pch_out_db
        ...
        carriers_att = list(map(lambda x: lin2db(x * 1e3) - temp, carriers_power))
