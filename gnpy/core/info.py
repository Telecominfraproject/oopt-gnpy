...
class SpectralInformation(object):
    ...
    def __init__(self, frequency: array, baud_rate: array, slot_width: array, signal: array, nli: array, ase: array,
                 roll_off: array, chromatic_dispersion: array, pmd: array, pdl: array, ref_power: Pref, label: str):
    ...
    def __add__(self, other: SpectralInformation):
        try:
            ...
            pref = Pref(self.pref.p_span0, self.pref.p_spani, p_span0_per_channel, self.pref.ref_carrier)
