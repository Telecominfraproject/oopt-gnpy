...
class SpectralInformation(object):
    ...
    def __add__(self, other):
        """
        :param other: instance of gnpy.core.info.SpectralInformation
        :return: instance of gnpy.core.info.SpectralInformation
        """
        try:
...
def create_arbitrary_spectral_information(frequency: Union[ndarray, Iterable, int, float],
                                          signal: Union[int, float, complex, ndarray, Iterable],
                                          baud_rate: Union[int, float, complex, ndarray, Iterable],
                                          slot_width: Union[int, float, complex, ndarray, Iterable] = None,
                                          roll_off: Union[int, float, complex, ndarray, Iterable] = 0,
                                          chromatic_dispersion: Union[int, float, complex, ndarray, Iterable] = 0,
                                          pmd: Union[int, float, complex, ndarray, Iterable] = 0):
    ...
    try:
        ...
        slot_width = full(number_of_channels, slot_width) if slot_width else \
