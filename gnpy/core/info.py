...
class SpectralInformation(object):
    ...
    def __init__(self, frequency: array, baud_rate: array, slot_width: array, signal: array, nli: array, ase: array,
                 roll_off: array, chromatic_dispersion: array, pmd: array, pdl: array, ref_power: Pref, label: array):
        ...
        self._pref = ref_power._replace(p_span0_per_channel=ref_power.p_span0_per_channel[indices])
    ...
    def __add__(self, other: SpectralInformation):
        try:
            ...
            pref = Pref(self.pref.p_span0, self.pref.p_spani, append(self.pref.p_span0_per_channel, other.pref.p_span0_per_channel),
                        self.pref.ref_carrier)
...
def use_initial_spectrum(initial_spectrum, ref_carrier):
    ...
    p_span0_per_channel = array([watt2dbm(s['power']) for s in initial_spectrum.values()])
