...
from gnpy.core.utils import automatic_nch, lin2db, db2lin, watt2dbm
...
def create_input_spectral_information(f_min, f_max, roll_off, baud_rate, power, spacing, ref_carrier=None):
    ...
    return create_arbitrary_spectral_information(frequency, slot_width=spacing, signal=power, baud_rate=baud_rate,
                                                 roll_off=roll_off, ref_power=Pref(p_span0=p_span0, p_spani=p_spani,
                                                 p_span0_per_channel=p_span0_per_channel, ref_carrier=ref_carrier))
