...
class PathRequest:
    ...
    def __str__(self):
        return f'PathRequest(request_id={self.request_id}, ' \
...
class Disjunction:
    ...
    def __str__(self):
        return f'Disjunction(disjunction_id={self.disjunction_id}, ' \
                + f'relaxable={self.relaxable}, ' \
                + f'link_diverse={self.link_diverse}, ' \
                + f'node_diverse={self.node_diverse}, ' \
                + f'disjunctions_req={self.disjunctions_req})'
