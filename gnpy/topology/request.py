...
from gnpy.core.info import create_input_spectral_information, use_pre_defined_spectrum_to_create_input_si
    ...
    if baudrate_to_explore:
        ...
        for this_br in baudrate_to_explore:
            ...
            if req.initial_spectrum is not None:
                ...
                msg = f'{ansi_escapes.red}Request: {req.request_id} contains a unexpected initial_spectrum. It is not' +\
                      f'considered for this request computation{ansi_escapes.reset}'
                LOGGER.critical(msg)
