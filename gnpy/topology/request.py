...
def compute_spectrum_slot_vs_bandwidth(req_bdwdth, req_spacing, req_bit_rate, slot_width=0.0125e12):
    """ computes the requested M and nb of wavelengths when trx_mode is defined.
    """
    ...
    requested_m = ceil(req_spacing / slot_width) * nb_wl
