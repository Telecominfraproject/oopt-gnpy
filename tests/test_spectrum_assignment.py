...
def test_freq_slot_exist(setup, equipment, requeste):
...
def test_inconsistant_freq_slot(setup, equipment, requeste):
...
@pytest.mark.parametrize('n, m, final_n, final_m, blocking_reason', [
    ...
    # overlapping with occupied spectrum means that requested spectrum is not available
...
def test_n_m_requests(setup, equipment, n, m, final_n, final_m, blocking_reason, requeste):
