...
@pytest.mark.parametrize('ids, modes, req_n, req_m, disjunction, final_ids, final_ns, final_ms, final_path_bandwidths', [
    ...
    (['a', 'b', 'c', 'd'], [None, None, None, 'mode 1'],
     [[0, 8], [None, 24], [32, 40], [None]], [[4, 4], [4, 4], [4, 4], [None]], [[]],
     ['a', 'b', 'c', 'd'], [[0, 8], [None, 24], [32, 40], [None]], [[4, 4], [4, 4], [4, 4], [None]], [200e9, 200e9, 200e9,200e9]),
    (['a', 'b', 'c', 'd'], ['mode 1', 'mode 1', 'mode 1', 'mode 1'],
     [[0], [16], [32], [48]], [[8], [8], [8], [8]], [['c', 'd', 'a']],
     ['a', 'b', 'c', 'd'], [[0], [16], [32], [48]], [[8], [8], [8], [8]], [200e9, 200e9, 200e9,200e9]),
    ])
def test_aggregation(ids, modes, req_n, req_m, disjunction, final_ids, final_ns, final_ms, final_path_bandwidths, request_set):
