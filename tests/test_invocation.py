...
@pytest.mark.parametrize("output, handler, args", (
    ...
    ('multiband_transmission', transmission_main_example,
     ['gnpy/example-data/multiband_example_network.json', 'Site_A', 'Site_D', '-e', 'gnpy/example-data/eqpt_config_multiband.json', '--show-channels'])
))
