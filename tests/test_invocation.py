...
@pytest.mark.parametrize("output, handler, args", (
    ...
    ('transmission_main_example__three_channels', transmission_main_example,
     ['--show-channels',  '-e',  'tests/data/eqpt_config_three_channels.json', 'tests/data/test_network.json']),
))
