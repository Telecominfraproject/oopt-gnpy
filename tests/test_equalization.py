...
def create_rq(equipment, source, dest, bidir, nodes_list, loose_list, mode, spacing, power_dbm):
...
def ref_network():
    ...
    equipment = load_equipment(EQPT_FILENAME)
    network = net_setup(equipment)
    req0 = create_rq(equipment, 'trx Brest_KLA', 'trx Vannes_KBE', False, ['trx Vannes_KBE'], ['STRICT'],
                     'mode 1', 50e9, 0)
