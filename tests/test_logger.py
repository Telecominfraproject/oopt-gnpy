...
def wrong_requests():
    ...
    data.append({
        ...
        'expected_msg': 'Requested M [{\'N\': -208, \'M\': 4}] number of slots for request Wrong_M support 0 nb of channels while 1 are required '
        + 'to support request 100.0 Gbit/s with Voyager mode 2'
    })
    return data
